                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6">
                        <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active"> <img class="d-block w-100" src="${p.image}" alt="First slide"> </div>
                            </div>

                        </div>
                    </div>
                    <form action="MainController?action=Add" method="POST">
                        <span class="title" hidden>Quantity: <input type="hidden" value="${p.id}" name="pid">
                        </span>
                        <div class="col-xl-7 col-lg-7 col-md-6">
                            <div class="single-product-details">
                                <h2>${p.name}</h2>
                                <h5>  $ ${p.price}</h5>
                                <p class="available-stock"><span>${p.quantity} available</span><p>
                                ...
                                <ul>
                                    <li>
                                        <div class="form-group quantity-box">
                                            ...
                                            <input class="form-control" value="1" min="1" max="${p.quantity}" name="quantity" type="number"/>
                                        </div>
                                    </li>
                                </ul>
