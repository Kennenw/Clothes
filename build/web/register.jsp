            ...
            <div class="contents order-2 order-md-1">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-7">
                            <h3>Register into <strong>Clothing Shop</strong></h3>
                            ...
                            <form action="MainController?action=register" method="post">
                                ...
                                <div class="d-flex mb-5 align-items-center">
                                    <span class="ml-auto"><a href="login.jsp" class="forgot-pass">Have account?</a></span> 
                                </div>
                                <div class="form-group">
                                    <input type="submit" value="Sign Up" class="btn btn-block btn-primary" style="background-color:  #ff8345;">
                                </div>
                            </form>
                        </div>
                    </div>
