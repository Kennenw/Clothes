            ...
            <div class="table-responsive" >
                <div class="table-wrapper" style="width: 55rem;">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2><a href="MainController?action=Home">Product Details</a></h2></div>
                            <a href="managecategory">
                                <div class="col-sm-8"><h2>Manage <b>Category</b></h2></div>
                            </a>
                            <div class="col-sm-4">
                                <a href="#AddNewProduct" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered" style="width: 50rem;">
                        ...
                        <tbody>
                            <c:forEach var="o" items="${pl}">
                                <tr>
                                    <td>${o.id}</td>
                                    <td>${o.name}</td>
                                    <td><img src="${o.image}" style="width: 4rem; height: 6rem;">
                                    </td>
                                    <td>${o.price}</td>
                                    <td>${o.quantity}</td>
                                    <td>${o.description}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="EditProduct?id=${o.id}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
